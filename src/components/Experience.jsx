      ...
      <div className="medium-text p-2">
        ...
        <div className="text p-4 small-text">
          ...
          <div className="pt-3 inline-flex items-center flex-wrap">
            ...
            <div className='pad-1'><span className="bg-blue-950 border border-blue-800 text-blue-400 rounded-lg px-2 py-1 text-xs">Debugging</span></div>
          </div>
        </div>
      </div>
      <div className="div-content bg-trans-1 pad-3 my-2 round-2">
        ...
        <div className="pt-3 inline-flex flex-wrap">
            ...
            <div className='pad-1'>
              <span className="bg-blue-950 border border-blue-800 text-blue-400 rounded-lg px-2 py-1 text-xs">React</span>
            </div>
            <div className='pad-1'>
